...
class ChildListWebViewTests(TestCase):
    ...
    def test_owner_sees_child_list(self):
        ...
        # Список рендерится на клиенте из json_script — проверяем данные,
        # а не литеральный текст имени в HTML (имя там в виде \uXXXX).
        self.assertContains(response, str(child.id))
