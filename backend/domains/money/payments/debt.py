# УСТАРЕЛО — не использовать. Реальный расчёт долга: domains.money.subscriptions.debt
# (другая формула: без взаимозачёта между абонементами одного ребёнка). См. TRU-68.
"""
